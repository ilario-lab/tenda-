...
self.addEventListener('fetch', e => {
  ...
  // Rete prima per i JSON delle bibbie e dei dizionari (file grandi, aggiornabili)
  if (url.pathname.startsWith('/bibles/') || url.pathname.startsWith('/dicts/')) {
    e.respondWith(
      fetch(e.request)
  ...
  // Cache prima per tutto il resto (app shell, icone, font)
  e.respondWith(
